...
//                        DatabaseReference user = FirebaseDatabase.getInstance().getReference().child("UserList").child(userId);
...
//                        user.setValue(hashMap);
                        ...
                        reference = FirebaseDatabase.getInstance().getReference().child("UserList").child(userId);
